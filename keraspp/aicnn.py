...
from keras import backend as krb
from keras.utils import np_utils as krnu
...
class DataSet:
    def __init__(self, X, y, nb_classes, scaling=True, test_size=0.2, random_state=0):
        ...
        Y_train = krnu.to_categorical(y_train, nb_classes)
        Y_test = krnu.to_categorical(y_test, nb_classes)
